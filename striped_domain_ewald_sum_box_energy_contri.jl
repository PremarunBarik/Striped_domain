...
term_1 = sum(term_1, dims=2)
term_1 = vec(sum(term_1, dims=1))/ N_sd

global distance = vec(sqrt.((x_pos_ES.^2) .+ (y_pos_ES.^2)))

scatter(distance, term_1, label=false, markerstrokewidth=0, markersize=2, framestyle=:box)
xlims!(1300, 1450)
ylims!(0, 0.00000005)
xlabel!("Distance of the box", guidefont=font(14), xtickfont=font(12))
ylabel!("Energy contribution", guidefont=font(14), xtickfont=font(12))
savefig("Energy_contribution_not_ewald_close_2.png")
