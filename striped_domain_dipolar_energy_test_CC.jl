...
function Ewald_sum_CC()
    ...
    term_1 = 1/2*((q_upper_upper ./ distance_upper_upper)
                .+ (q_upper_lower ./ distance_upper_lower)
                .+ (q_lower_lower ./ distance_lower_lower)
                .+ (q_lower_upper ./ distance_lower_upper))
