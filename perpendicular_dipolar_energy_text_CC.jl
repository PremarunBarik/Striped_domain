...
term_1 = 1/2*(replace!((q_upper_upper ./ distance_upper_i_upper_j), Inf=>0)
                .+ replace!((q_upper_lower ./ distance_upper_i_lower_j), Inf=>0)
                .+ replace!((q_lower_upper ./ distance_lower_i_upper_j), Inf=>0)
                .+ replace!((q_lower_lower ./ distance_lower_i_lower_j), Inf=>0))
