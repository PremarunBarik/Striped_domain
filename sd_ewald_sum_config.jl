...
global alpha_ratio = 1.5     #defined parameter for dipolar interaction energy
...
function compute_tot_energy_spin_glass()
    ...
    global energy_tot = (energy_exchange .- (alpha_ratio .* energy_ewald_sum_CC) .+ (B_global*z_dir_sd))
...
function plot_heatmap(MC_step)
    ...
    savefig("striped_domins_alpha$(alpha_ratio)_temp$(Temp)_t$(MC_step).png")
